...
### Publications:
* M.A. Sánchez et al. An r-adaptive finite element method using neural networks for parametric self-adjoint elliptic problems. *Journal of Computational Physics*, 520, 114447, 2026.
* M.A. Sánchez et al. Stokes-PINNs: Physics-Informed Neural Networks for Blood Flow Reconstruction in Complex Geometries. *SSRN Preprint*, 2026.
* M.A. Sánchez et al. Symplectic Hamiltonian hybridizable discontinuous Galerkin methods for linearized shallow water equations. *Computer Methods in Applied Mechanics and Engineering*, 434, 118383, 2025.
* M.A. Sánchez et al. Experiments and finite element simulations pertinent to hydrogel debonding from a solid substrate. *Polymer*, 315, 128702, 2025.
